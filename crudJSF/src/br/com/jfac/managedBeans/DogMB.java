...
public class DogMB {
	...
	public String updateDogEnd() {
		try {
			...
			sendErrorMessageToUser("Error. Verifique se o tamanho está abaixo de zero(0) ou contacte o administrador.");
			return STAY_IN_THE_SAME_PAGE;
		}

		sendInfoMessageToUser("Opera��o completada: Dados Atualizados.");
	...
	public String createDogEnd() {
		try {
			...
			sendErrorMessageToUser("Error. Verifique se o tamanho é maior que zero(0) ou contacte o administrador.");
